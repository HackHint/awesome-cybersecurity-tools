...
> A curated list of awesome cybersecurity tools, scanners, frameworks, and resources. Maintained by HackHint.

---

## 📜 Table of Contents

1.  [HackHint's Cybersecurity Toolset](#️-hackhints-cybersecurity-toolset)
2.  [General Tool Lists](#general-tool-lists)
3.  [Multi-paradigm Frameworks](#multi-paradigm-frameworks)
4.  [Network Vulnerability Scanners](#network-vulnerability-scanners)
5.  [Network Tools](#network-tools)
6.  [Wireless Network Tools](#wireless-network-tools)
7.  [Transport Layer Security Tools](#transport-layer-security-tools)
8.  [Web Exploitation](#web-exploitation)
9.  [Hex Editors](#hex-editors)
10. [File Format Analysis Tools](#file-format-analysis-tools)
11. [Anti-virus Evasion Tools](#anti-virus-evasion-tools)
12. [Hash Cracking Tools](#hash-cracking-tools)
13. [Windows Utilities](#windows-utilities)
14. [GNU/Linux Utilities](#gnulinux-utilities)
15. [macOS Utilities](#macos-utilities)
16. [DDoS Tools](#ddos-tools)
17. [Social Engineering Tools](#social-engineering-tools)
18. [OSINT Tools](#osint-tools)
19. [Anonymity Tools](#anonymity-tools)
20. [Reverse Engineering Tools](#reverse-engineering-tools)
21. [Physical Access Tools](#physical-access-tools)
22. [Industrial Control and SCADA Systems](#industrial-control-and-scada-systems)
23. [Side-channel Tools](#side-channel-tools)
24. [CTF Tools](#ctf-tools)
25. [Penetration Testing Report Templates](#penetration-testing-report-templates)
26. [More Tools](#more-tools)

---

## 🛡️ HackHint's Cybersecurity Toolset

A suite of professional cybersecurity tools and resources developed by the [**HackHint**](https://hackhint.com/) company.

* [**HackHint.com**](https://hackhint.com/) - The main portal for HackHint's cybersecurity blog, how-to guides, and educational content for security professionals and enthusiasts.
* [**CVE Tracker (cve.hackhint.com)**](https://cve.hackhint.com/) - A real-time vulnerability database and dashboard that tracks and details Common Vulnerabilities and Exposures (CVEs) sourced from the NVD API.
* [**HackHint Tools (tools.hackhint.com)**](https://tools.hackhint.com/) - A collection of free online security utilities for researchers and developers, including a CVE Lookup and a secure Password Generator.
...
* [SecTools.Org: Top 125 Network Security Tools](https://sectools.org/) - For more than a decade, the Nmap Project has been cataloguing the network security community's favorite tools.
...
* [mimikatz](httphttp://blog.gentilkiwi.com/mimikatz) - Credentials extraction tool for Windows operating system.
...
* [Cr3d0v3r](httpss://github.com/D4Vinci/Cr3dOv3r) - Know the dangers of credential reuse attacks.
...
* [procyon](httpshttps://bitbucket.org/mstrobel/procyon/wiki/Java%20Decompiler) - A modern open-source Java decompiler.
...
Contributions are always welcome! If you have a tool you'd like to add, please feel free to open a pull request.

Please ensure your pull request adheres to the following guidelines:

* Search previous suggestions before making a new one to avoid duplicates.
* Add the new tool to the appropriate category.
* Use the format: `* [Tool Name](Link) - Brief description.`
* Make sure your link is to the official tool page or repository, not a blog post or tutorial.
...
<p align="center">
  <strong>Made with ❤️ by <a href="https://hackhint.com">HackHint</a></strong>
</p>
